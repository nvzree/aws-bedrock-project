...
resource "aws_bedrockagent_knowledge_base" "main" {
  ...
  storage_configuration {
    type = "RDS"
    rds_configuration {
      credentials_secret_arn = var.aurora_secret_arn #"arn:aws:secretsmanager:us-west-2:187816014454:secret:my-aurora-serverless-Ms88Cb" 
      database_name = var.aurora_db_name #"myapp"
      resource_arn = var.aurora_arn #"arn:aws:rds:us-west-2:187816014454:cluster:my-aurora-serverless"
      table_name =  var.aurora_table_name #"bedrock_integration.bedrock_kb" 
      field_mapping {
